...
<el-container>
  ...
  <el-main>
    <el-row>
      ...
      <el-col :span="7">
        <el-input v-model="input" placeholder="请输入学号或姓名"></el-input>
      </el-col>
  ...
  <el-table
    ...
    <el-table-column prop="year" label="学年" sortable width="120"></el-table-column>
    <el-table-column prop="term" sortable label="学期" width="120"></el-table-column>
    <el-table-column prop="classno" sortable label="课程代号" width="120"></el-table-column>
    <el-table-column prop="classname" sortable label="课程名" width="120"></el-table-column>
    <el-table-column
      prop="point"
      sortable
      label="学分"
